...
public class LocalStorageFileServiceImpl implements FileService {
  ...
  public String getFileExtension(String fileName) {
    ...
    @Override
    public Future<JsonObject> uploadGtfsRealtime(final FileUpload fileUpload, String fileName, String filePath){
      Promise<JsonObject> promise = Promise.promise();
    ...
    @Override
    public Future<JsonObject> downloadGtfsRealtime(final String fileName, String uploadDir, final HttpServerResponse response) {
      Promise<JsonObject> promise = Promise.promise();
      JsonObject finalResponse = new JsonObject();
      String path = getLocalDirectory(fileName, uploadDir);
      LOGGER.info(path);

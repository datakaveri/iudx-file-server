...
public enum ResponseUrn {
  ...
  INVALID_TEMPORAL_RELATION_VALUE("urn:dx:rs:InvalidTemporalRelationValue","Invalid temporal param value"),
  INVALID_TEMPORAL_DATE_FORMAT("urn:dx:rs:InvalidTemporalDateFormat","Invalid temporal param value date format"),
  ...
  MANDATORY_FIELD("urn:dx:rs:missingMandatoryField","A mandatory field is missing"),  // TODO: is this an acceptable response urn?
